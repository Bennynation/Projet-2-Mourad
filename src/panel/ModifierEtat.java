...
////////////////////////////////////////////////////////////////////
// Cas d'utilisation Modification de l'�tat d'un v�hicule
// Benoit L�gar�
////////////////////////////////////////////////////////////////////
...
public class ModifierEtat extends JPanel {
	...
	public ModifierEtat() {
		...
		btnModifier.addActionListener(e -> {
			if (!txtNom.getText().equals("")) { // V�rifie la s�lection d'un v�hicule
				if (!txtDesc.getText().equals(desc) || !cbEtat.getSelectedItem().toString().equals(etat)) // V�rifie
																											// s'il
																											// y a
																											// eu un
																											// changement
		...
		btnRechercher.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				case 0:
					DefaultListModel listModel = new DefaultListModel() { // Affiche tous les v�hicules
					...
					break;
				case 1:
					DefaultListModel listModel1 = new DefaultListModel() { // Affiche tous les v�hicules simple
					...
					break;
				case 2:
					DefaultListModel listModel2 = new DefaultListModel() { // Affiche tous les v�hicules utilitaires
					...
					break;
				case 3:
					DefaultListModel listModel3 = new DefaultListModel() { // Affiche tous les v�hicules prestige
		...
		lVehicules.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) { // Lors du changement de l'index dans le tableau de
																// v�hicules on affiche les bonnes informations.
