...
public class MenuPrincipal extends JFrame {
	...
	public static void main(String[] args) {
		...
		listCompte.addCompte(new Client("Client", "AFD510", "34543534543", 0, 1, "Legare", "Benoit", "Jean", 395,
				"Trois-Rivi�res", "G8W5Y6", "123", "1"));
		listCompte.addCompte(new Client("FDA", "AFD610", "34543534543", 1, 2, "Bouche", "Jeremy", "Jean", 400,
				"Trois-Rivi�res", "G8W5Y4", "123", "1"));
		listCompte.addCompte(
				new Manager("Manager", 3, "Bouche", "Frank", "Jean", 400, "Trois-Rivi�res", "G8W5Y4", "123", ""));
		listCompte.addCompte(
				new Prepose("Prepose", 4, "Roche", "Moe", "Jean", 400, "Trois-Rivi�res", "G8W5Y4", "123", ""));
		listCompte.addCompte(new Gestionnaire("Gestion", 5, "Bouche", "Francis", "Jean", 400, "Trois-Rivi�res",
				"G8W5Y4", "123", ""));
		...
		listVehicule.addVehicule(
				new Simple(3, "xC40 momentum", "Cam�ra de recule", "4 cylindres", 5, "En service", "", 500));
		listVehicule
				.addVehicule(new Simple(4, "xC60 momentum", "Banc chauffant", "4 cylindres", 5, "En service", "", 500));
		listVehicule
				.addVehicule(new Prestige(5, "1995 mr2", "Cam�ra de recule", "4 cylindres", 5, "En service", "", 500));
	...
	public void load(JPanel p) { // Ajoute le jPanel pass� en param�tre
	...
	public static void connexion(String id, String mtp) { // Selon le compte connect�, on fait apparaitre uniquement ce
															// qu'il peut acc�der.
		compteUser = listCompte.getCompte(id, mtp); // On regarde l'existence du compte � l'aide du ClasseurCompte, car
	...
	public static void erreur(String message) { // Utiliser pour g�n�rer un message d'erreur
		JOptionPane.showMessageDialog(contentPane, message, "Erreur", JOptionPane.WARNING_MESSAGE);
	}

	public static void confirmation(String message) { // Utiliser pour g�n�rer un message de confirmation
